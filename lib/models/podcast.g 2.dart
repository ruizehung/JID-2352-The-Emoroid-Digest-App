...
extension PodcastQueryFilter
  ...
  QueryBuilder<Podcast, Podcast, QAfterFilterCondition> hasReadEqualTo(
      bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'hasRead',
...
extension PodcastQuerySortBy on QueryBuilder<Podcast, Podcast, QSortBy> {
  ...
  QueryBuilder<Podcast, Podcast, QAfterSortBy> sortByHasRead() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'hasRead', Sort.asc);
    });
  }

  QueryBuilder<Podcast, Podcast, QAfterSortBy> sortByHasReadDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension PodcastQuerySortThenBy
  ...
  QueryBuilder<Podcast, Podcast, QAfterSortBy> thenByHasRead() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'hasRead', Sort.asc);
    });
  }

  QueryBuilder<Podcast, Podcast, QAfterSortBy> thenByHasReadDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'hasRead', Sort.desc);
    });
  }
...
extension PodcastQueryWhereDistinct
  ...
  QueryBuilder<Podcast, Podcast, QDistinct> distinctByHasRead() {
    return QueryBuilder.apply(this, (query) {
...
extension PodcastQueryProperty
  ...
  QueryBuilder<Podcast, bool, QQueryOperations> hasReadProperty() {
    return QueryBuilder.apply(this, (query) {
